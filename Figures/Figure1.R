...
popsizes <- read.table('../interventions/final_frequencies_with_interventions.txt', row.names=NULL,header=T)
...
draw <- function(r1,r2,p12,p22,q2,is2, ig, main=NA)
	{	
	# use MD[1] = 0.05
image(x=log(q1,10),y=log(is1,10),z=matrix(s2[get_subset(c('r12'=r1,'r21'=r2,'p12'=p12,'p22'=p22, 'MD'=md,'Ig'=ig,'q2'=q2,'is2'=is2))], nrow=15,byrow=T),xlab=expression('Log'[10]*' isolation effort'),ylab=expression('Log'[10]*' quarantine effort'),col=tim.colors(64),main=ifelse(!is.na(main), main, paste('med help=',md,'Ignored=',ig,'h1 risk=',r1,'mixing=',r2,'\nphen h1=',p12,'phen h2=',p22,'q help=',q2,'is help=',is2)),cex.main=0.8,zlim=range(s2,na.rm=T),cex.lab=1.8,cex.main=2,cex.axis=1.4)
	}

par(las=1,mfrow=c(4,4),pty='s')
#dev.copy2pdf(file='Fig1a.pdf')
draw(r1=10,r2=0.1,p12=5,p22=13,q2=0.001,is2=0.001,ig=1,main='(A)')
draw(r1=100,r2=0.01,p12=13,p22=5,q2=1,is2=0.001,ig=1,main='(B)')
draw(r1=10,r2=0.1,p12=5,p22=13,q2=1,is2=0.001,ig=0.1,main='(C)')
draw(r1=10,r2=1,p12=5,p22=5,q2=0.001,is2=0.001,ig=1,main='(D)')
draw(r1=10,r2=1,p12=5,p22=13,q2=0.001,is2=0.001,ig=1,main='(E)')
draw(r1=10,r2=0.1,p12=5,p22=13,q2=0.001,is2=0.001,ig=0.1,main='(F)')
draw(r1=10,r2=0.01,p12=13,p22=1.1,q2=0.001,is2=0.001,ig=0.1,main='(G)')
draw(r1=10,r2=0.01,p12=13,p22=5,q2=0.001,is2=0.001,ig=0.1,main='(H)')
draw(r1=10,r2=1,p12=1.1,p22=1.1,q2=0.001,is2=1,ig=0.1,main='(I)')
draw(r1=10,r2=1,p12=5,p22=1.1,q2=1,is2=0.001,ig=0.1,main='(J)')
draw(r1=10,r2=1,p12=13,p22=5,q2=1,is2=0.001,ig=0.1,main='(K)')
draw(r1=10,r2=0.01,p12=1.1,p22=13,q2=1,is2=0.001,ig=0.1,main='(L)')
draw(r1=10,r2=0.01,p12=1.1,p22=13,q2=0.001,is2=0.001,ig=0.1,main='(M)')
draw(r1=10, r2=0.1,p12=1.1,p22=5,q2=0.001,is2=0.001,ig=0.1,main='(N)')
draw(r1=10, r2=0.01,p12=13,p22=1.1,q2=1,is2=0.001,ig=0.1,main='(O)')
draw(r1=10, r2=1,p12=13,p22=1.1,q2=1,is2=0.001,ig=1,main='(P)')
